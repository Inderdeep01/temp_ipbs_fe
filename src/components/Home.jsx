...
const Home = () => {
  return (
    <div id='home'>
      <div class="mb-5 mb-lg-0" style={{zIndex: "10"}}>
        <h1 id='home-h1' class="my-5 fw-bold ls-tight" style={{color: "#fca311", fontSize:'4.5rem'}}>
        Inter-Planetary <br></br>
          <span style={{color: "#1d3557"}}>Banking System</span>
        </h1>
        <p id='para' class="mb-4 opacity-70" style={{color: "#000000"}}>
      ...
      <div class="mb-5 mb-lg-0" style={{zIndex: "10"}}>
        <h1 id='home-h2' class="my-5 fw-bold ls-tight" style={{color: "#fca311", fontSize:'3.5rem'}}>
        Why
